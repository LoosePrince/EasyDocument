...
配置GitHub相关功能，详见[GitHub与Git功能配置](?path=配置详解/GitHub与Git功能.md)文档。
...
配置Git相关功能，详见[GitHub与Git功能配置](?path=配置详解/GitHub与Git功能.md)文档。
...
2. **目录设置**：`toc_depth`、`toc_numbering`和`toc_ignore_h1`共同决定文档右侧目录的显示方式。
...
- [Markdown语法指南](?path=快速入门/Markdown语法.md) 